...
# Directories set up
export DATA_ROOT=/ha/projects/vystadial/nobackup/asr-mixer/es-voip # expects subdirectories train + $TEST_SETS
export WORK=`pwd`/model_es_voip
export EXP=`pwd`/model_es_voip/exp
export TGT_MODELS=exported/es_voip
